...
class TestPlanet(unittest.TestCase):
    ...
    def test_planet_name_from_portal_code_2(self):
        ...
        seed = planetSeed(0x2002FF285671, 9)
        name = planetName(seed)
        self.assertEqual(name, "Nosyulva")    
        seed = planetSeed(0x3002FF285671, 9)
        name = planetName(seed)
        self.assertEqual(name, "Udde Gamma")
        seed = planetSeed(0x4002FF285671, 9)
        name = planetName(seed)
        self.assertEqual(name, "New Yasosold")
